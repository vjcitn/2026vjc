...
![]({{< var dsbook2 >}}ml/img/cv-1.png){fig-align=center}
...
![]({{< var dsbook2 >}}ml/img/cv-3.png){fig-align=center}

## Cross validation

![]({{< var dsbook2 >}}ml/img/cv-4.png){fig-align=center}
...
![]({{< var dsbook2 >}}ml/img/cv-5.png){fig-align=center}
...
![]({{< var dsbook2 >}}ml/img/cv-6.png){fig-align=center}
...
![]({{< var dsbook2 >}}ml/img/cv-7.png){fig-align=center}
...
![]({{< var dsbook2 >}}ml/img/cv-8.png){fig-align=center}
