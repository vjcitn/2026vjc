...
- Other significant advances include movie recommendation systems, spam and malware detection, housing price prediction algorithms, the ongoing development of autonomous vehicles and biomedical applications (genomics, transcriptomics, proteomics, etc).
