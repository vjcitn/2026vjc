...
#url <- "http://web.archive.org/web/20260711162616/http://stevetheump.com/Payrolls.htm"
url <- "https://raw.githubusercontent.com/vjcitn/2026vjc/main/wayback/Payrolls.htm"
h <- read_html(url)  
...
![]({{< var dsbook2 >}}linear-models/img/Baseball_Diamond1.png)
...
![]({{< var dsbook2 >}}linear-models/img/JumboTron.png)
