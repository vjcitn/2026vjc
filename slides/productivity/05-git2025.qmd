---
title: "Git and GitHub, 2025 edition"
...
## note for 2026 class: because we have already established github accounts we will be skipping many of the details here
...
* Even more important when there are multiple files, as there is in software development, and to some extent data analysis.
...
* When setting permissions for the token, choose _non-expiring and select the repo option_ in the scopes section.
...
![]({{< var dsbook1 >}}productivity/img/git/git-layout.png)

----

## Status

![]({{< var dsbook1 >}}productivity/img/git/git-status.png)
```{r}
#| echo: true
#| eval: false
#| code-line-numbers: false
...
![]({{< var dsbook1 >}}productivity/img/git/git-add.png)
...
![]({{< var dsbook1 >}}productivity/img/git/git-commit.png)
...
![]({{< var dsbook1 >}}productivity/img/git/git-push.png)
...
![]({{< var dsbook1 >}}productivity/img/git/git-fetch.png)
...
![]({{< var dsbook1 >}}productivity/img/git/git-merge.png)
...
![]({{< var dsbook1 >}}productivity/img/git/git-pull.png)
...
* We are just scratching the surface of Git.
